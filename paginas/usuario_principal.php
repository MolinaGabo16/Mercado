...
<body align="center">
  ...
  <header>
  		<div class="contenedor" id="uno">
  			<a href="nueva_venta.php"><img class="icon" src="pictures/Cart.png"></a>
  			<p class="texto">Nueva Venta</p>
  		</div>
  		<div class="contenedor" id="dos">
  			<a href="ventas.php"> <img class="icon" src="pictures/Search.png"></a>
  			<p class="texto">Ver Productos</p>
  		</div>
  		<div class="contenedor" id="tres">
  			<a href="datos.php"> <img class="icon" src="pictures/List.png"></a>
  			<p class="texto">Mis Ventas</p>
  		</div>
  		<div class="contenedor" id="cuatro">
  		<a href="comentario.php">	<img class="icon" src="pictures/Massage.png"></a>
  			<p class="texto">Enviar Comentario</p>
  		</div>
  		<div class="contenedor" id="cinco">
  			<a href="ayuda.php">	<img class="icon" src="pictures/info.png"></a>
...
if($consulta1->num_rows > 0){
  $cad2="<img src='../imgPag/notificacion.png' width='100' height='100'>";
  echo $cad2;
  echo"<h4> Alguien a comentado tus siguientes productos </h4><br>";
